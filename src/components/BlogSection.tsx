            ...
            <div className="write-card">
              ...
              <div style={{ flex: 1, maxWidth: '520px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <a href="mailto:contact@allbotix.ai" style={{ fontFamily: 'var(--font-display)', fontSize: '0.72rem', color: 'var(--red-bright)', textDecoration: 'none', letterSpacing: '0.06em', transition: 'opacity 0.2s' }}>
                    Submit Your Article: contact@allbotix.ai
                  </a>
                </div>
              </div>
            </div>
