  ...
  return (
    <>
      <style>{`
        ...
        .sc-glow-l { top: 10%; left: -10%; width: 520px; height: 520px; background: radial-gradient(circle, rgba(var(--red-dark-rgb),0.08) 0%, transparent 70%); }
        .sc-glow-r { bottom: 5%; right: -8%; width: 420px; height: 420px; background: radial-gradient(circle, rgba(var(--red-dark-rgb),0.06) 0%, transparent 70%); animation-delay: 1.5s; }
        ...
        .sc-card:hover {
          background: var(--bg-700); border-color: rgba(var(--red-dark-rgb),0.28);
          transform: translateY(-3px);
          box-shadow: 0 16px 40px rgba(var(--black-rgb),0.45), 0 0 20px rgba(var(--red-dark-rgb),0.07);
        }
        ...
        .sc-card-num {
          ...
          color: transparent; -webkit-text-stroke: 1px rgba(var(--red-dark-rgb),0.08);
          line-height: 1; pointer-events: none; user-select: none;
          transition: -webkit-text-stroke 0.3s;
        }
        .sc-card:hover .sc-card-num { -webkit-text-stroke: 1px rgba(var(--red-dark-rgb),0.2); }

        .sc-card-icon {
          width: 42px; height: 42px; border-radius: 6px;
          display: flex; align-items: center; justify-content: center;
          margin-bottom: 1rem; background: rgba(var(--red-dark-rgb),0.12);
          color: var(--red-bright); flex-shrink: 0;
          transition: background 0.25s, filter 0.25s;
        }
        .sc-card:hover .sc-card-icon { background: rgba(var(--red-dark-rgb),0.2); filter: drop-shadow(0 0 7px rgba(var(--red-accent-rgb),0.4)); }
